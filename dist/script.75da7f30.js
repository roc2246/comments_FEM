...
fetch("http://localhost:3000/combined").then(function (response) {
  ...
  var element = {
    ...
    username: function username(source) {
      var currentUser = data[0].currentUser;
  ...
  container.form.comment.addEventListener("submit", function (e) {
    e.preventDefault();
    var _data$2 = data[0],
      comments = _data$2.comments,
      currentUser = _data$2.currentUser;
  ...
  var _loop6 = function _loop6(_x5) {
    container.form.reply[_x5].addEventListener("submit", function (e) {
      e.preventDefault();
      var _data$3 = data[0],
        comments = _data$3.comments,
        currentUser = _data$3.currentUser;
  ...
  var _loop7 = function _loop7(_x6) {
    container.form.replyToReply[_x6].addEventListener("submit", function (e) {
      e.preventDefault();
      var _data$4 = data[0],
        comments = _data$4.comments,
        currentUser = _data$4.currentUser;
